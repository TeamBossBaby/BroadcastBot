...
async def startprivate(client, message):
    ...
    joinButton = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/TheBotsWorldChannel"),
                InlineKeyboardButton(
                    "SUPPORT GROUP", url="https://t.me/TheBotsWorldChannel"
                ),
            ]
        ]
    )
    welcomed = f"Hey <b>{message.from_user.first_name}</b>\nI'm a simple Telegram bot that can broadcast messages and media to the bot subscribers. Made by @TheBotsWorldChannel.\n\n 🎚 use /settings"
